 ...
 * Build: http://modernizr.com/download/#-fontface-backgroundsize-borderradius-opacity-rgba-cssanimations-generatedcontent-csstransforms-csstransforms3d-csstransitions-video-input-inputtypes-inlinesvg-svg-shiv-mq-cssclasses-prefixed-teststyles-testprop-testallprops-prefixes-domprefixes-css_backgroundsizecover-css_displaytable-css_filters-css_lastchild-css_pointerevents-css_vhunit-css_vmaxunit-css_vminunit-css_vwunit-forms_placeholder-requestanimationframe-svg_filters-load
 */
;
...
}), Modernizr.addTest("raf", !! Modernizr.prefixed("requestAnimationFrame", window)), Modernizr.addTest("svgfilters", function() {
    var a = !1;
    try {
